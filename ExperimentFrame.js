class ExperimentFrame {
    ...
    showTrial() {
        ...
        const STRectDrawing = new STRectsDrawing(currentTrial, this.currentBlock, this.blockNumber, this.trialNumber, this.experiment.rectSize, this.dataRecorder, this.username, () => {
            this.trialCompleted();
        });
